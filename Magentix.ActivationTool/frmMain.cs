...
namespace DemoActivationTool
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            {
                _assembly.GetManifestResourceStream("Magentix.ActivationTool.LicenseSign.pfx").CopyTo(_mem);
            ...
            licSettings.License = new MagentixLicense(); 
        }

        private void licSettings_OnLicenseGenerated(object sender, Magentix.QLicense.Windows.Controls.LicenseGeneratedEventArgs e)
        {
