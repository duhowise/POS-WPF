...
namespace Magentix.Presentation.Tests
{
    ...
    public static class MefBootstrapper
    {
        ...
        static MefBootstrapper()
        {
            ...
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Magentix.Persistance.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Magentix.Presentation*"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Magentix.Services*"));
