...
html
{
  font-family: 'Courier New', monospace;
    ...
    public static class LocalSettings
    {
        ...
        public static string DataPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\" + AppName; } }
        public static string UserPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\" + AppName; } }
        ...
        private static string DefaultAppVersion { get { return "1.0.0"; } }
        ...
        public static IList<string> SupportedLanguages { get { return _supportedLanguages ?? (_supportedLanguages = new[] { "en", "de", "fr", "tr" }); } }
