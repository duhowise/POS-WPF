...
namespace Magentix.Infrastructure.Helpers
{
    public static class DateFuncParser
    {
        ...
        public static DateTime Parse(string expression, DateTime currentDate)
        {
            DateTime dateTime;
            DateTime.TryParse(DateFuncParser.Parse(expression, currentDate.ToString()), out dateTime);
            return dateTime;
        }
