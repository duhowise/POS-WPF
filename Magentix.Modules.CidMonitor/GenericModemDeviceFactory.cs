...
namespace Magentix.Modules.CidMonitor
{
    ...
    internal class GenericModemDeviceFactory : AbstractDeviceFactory
    {
        ...
        {
            return (string x) => new GenericModemDevice(x, this.GetName(), this._applicationState, this._cacheService, this._entityService, this._applicationStateSetter, this._printerService);
        }
