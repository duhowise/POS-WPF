...
namespace Magentix.Modules.MenuModule
{
    ...
    public class ScreenMenuCategoryViewModel : ObservableObject
    {
        ...
        [LocalizedCategory(ResourceStrings.MenuProperties)]
        [LocalizedDisplayName("SortAlphabetically")]
        public bool SortAlphabetically
        {
            get
            {
                return this.Model.SortAlphabetically;
            }
            set
            {
                this.Model.SortAlphabetically = value;
                base.RaisePropertyChanged<bool>(Expression.Lambda<Func<bool>>(Expression.Property(Expression.Constant(this, typeof(ScreenMenuCategoryViewModel)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(ScreenMenuCategoryViewModel).GetMethod("get_SortAlphabetically").MethodHandle)), new ParameterExpression[0]));
            }
        }
