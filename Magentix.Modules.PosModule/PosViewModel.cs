...
namespace Magentix.Modules.PosModule
{
    ...
    public class PosViewModel : ObservableObject
    {
        ...
        public void DisplayTickets()
        {
            ...
            if (!this.ShouldDisplayTicketView())
            {
                CommonEventPublisher.PublishEntityOperation<Entity>(null, EventTopicNames.SelectEntity, EventTopicNames.EntitySelected, "");
                return;
            }
            this._applicationStateSetter.SetCurrentApplicationScreen(AppScreens.TicketView);
            if (this.SelectedTicket == null)
            {
                this.SelectedTicket = null;
            }
            this.DisplaySingleTicket();
        }
        ...
        private bool ShouldDisplayTicketView()
        {
            if (this.SelectedTicket != null)
            {
                return true;
            }
            return this._applicationState.ShouldDisplayTicketView();
        }
    }
}
