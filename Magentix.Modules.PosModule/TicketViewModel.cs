...
namespace Magentix.Modules.PosModule
{
    ...
    public class TicketViewModel : ObservableObject
    {
        ...
        private bool CanSelectEntity(EntityType arg)
        {
            ...
            return arg != null && !SelectedTicket.IsLocked && SelectedTicket.CanSubmit && _applicationState.GetTicketEntityScreens(this._applicationState.CurrentTicketType.Id).Any(x => x.EntityTypeId == arg.Id);
        }
