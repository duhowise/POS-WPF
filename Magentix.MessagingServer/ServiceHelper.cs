...
namespace Magentix.MessagingServer
{
    ...
    {
        private static readonly string _installAssembly = "Magentix.MessagingServer.WindowsService.exe";
        private static readonly string _logFile = "WindowsServiceInstall.log";
        private static readonly string _serviceName = "MagentixPOS3-MessagingServer";
